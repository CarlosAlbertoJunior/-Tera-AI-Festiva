  ...
  template: `
    <footer class="bg-dark text-white py-5 border-top border-success mt-auto">
      <div class="container text-center">
        <h4 class="fw-bold mb-4">CN <span class="text-success">Ótica</span></h4>
        ...
        <p class="text-secondary small mb-0">&copy; 2026 CN Ótica Premium. Todos os direitos reservados.</p>
